        ...
        if st.button("대시보드 생성하기 (Pain Point & HMW 포함)"):
            with st.spinner('AI가 데이터를 분석하여 6단계 대시보드를 생성 중입니다. 다소 시간이 걸릴 수 있습니다...'):
                ...
                6. HMW (How Might We) 도출: 재정의된 문제를 바탕으로, 아래 [문제의 기회 요소 발견 7요소 기반 HMW 가이드]를 적용하여 긍정적이고 창의적인 해결책을 촉발할 수 있는 '우리가 어떻게 하면 ~할 수 있을까?' 질문을 최소 5개, 최대 7개 작성
                   ...
                   - 세부 행동지표, 조건, 절차, 예시는 질문 안에 나열하지 말고 상위 개념으로 묶어 의미 훼손 없이 줄이세요.
                   - HMW 질문은 35~55자 내외를 권장하며, 길어도 70자를 넘기지 마세요.
                        ...
                        <div class="hmw-list">
                            <div class="hmw-item">
                                ...
                                <div class="hmw-content">
                                    <h4>기회 요소 1: 긍정적 요소 강화 · 여기에 해결 방향성을 작성하세요</h4>
                            ...
                            <div class="hmw-item">
                                <div class="hmw-icon">🚀</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 2: 부정적 요소 제거 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                            <div class="hmw-item">
                                    <div class="hmw-icon">🏆</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 3: 반대로 뒤집기 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                            <div class="hmw-item">
                                <div class="hmw-icon">🔍</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 4: 가정에 의문 제기하기 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                            <div class="hmw-item">
                                <div class="hmw-icon">✨</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 5: 형용사 사용 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                            <div class="hmw-item">
                                <div class="hmw-icon">🧩</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 6: 예상치 못한 자원 활용 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                            <div class="hmw-item">
                                <div class="hmw-icon">🌉</div>
                                <div class="hmw-content">
                                    <h4>기회 요소 7: 유추와 비유 · 여기에 해결 방향성을 작성하세요</h4>
                                    <p>우리가 어떻게 하면 [사용자]가 [의도하는 행동/경험]을 통해 [원하는 결과]를 얻을 수 있을까?</p>
                                </div>
                            </div>
                        </div>
